    ...
    <section class="card-content">
        <div class="wrapper cards">
            ...
            <div class="back-button">
                <a href="loggedin.php"><i class="fa-solid fa-arrow-left fa-lg" style="color: #3b3b3b;"></i>  Back</a>
            </div>
            <div class="card auction-card">
                ...
                <div class="card-details">
                    ...
                    <div class="description">
                        ...
                        <p><?php echo $item->item_description ; ?>
                        </p>
                    </div>
                    ...
                    <div class="card-bid">
                        <a href="../../../controller/admis/item/delete.php?item_id=<?php $item->item_id ; ?>">
                        <button>delete</button>
                        </a>
                        <br>
                        <a href="edit.php?item_name=<?php echo $item->item_name ; ?>">
                        <button>edit</button>
                        </a>
                    </div>
