...
<body>
    ...
    <div class="product-form">
        <h3>Add Your Item</h3>
        <form class="product-container" method="post" action="/controller/admis/item/create.php" enctype="multipart/form-data">
            ...
            <textarea class="form-control-1" id="item-description" name="item_description"
            ...
            <button type="submit" class="product-btn" name="add_item">Add Product</button>
        </form>
    </div>
